...
public abstract class QUnitTest extends GroovyObjectSupport {
	...
	class TheTestSuite {
		...
		TheTestSuite(QUnitTestPage page) {
			...
			List<DomNode> testNodes = page.driver.findElementsByXPath("//ol[@id='qunit-tests']//li[contains(@id,'test-output')]");
	...
	private Configuration[] getConfigurationsNullSafe() {
		return getConfigurations() != null ? getConfigurations().toArray(new Configuration[]{}) : new Configuration[]{};
	}
