...
class AutoGeneratedQunitHtmlWrappers extends HttpObject {
    ...
    private final String requireDotJsShim;
    
    public AutoGeneratedQunitHtmlWrappers(String requireDotJsShim) {
        super("/{resource*}");
        this.requireDotJsShim = requireDotJsShim;
    }
    ...
    public Response get(org.httpobjects.Request req) {
        ...
        final String generatedHtmlFileContent = TEMPLATE.
        											...
        											replaceAll("YOUR_REQUIRE_DOT_JS_SHIM_GOES_HERE", Matcher.quoteReplacement(requireDotJsShim));
