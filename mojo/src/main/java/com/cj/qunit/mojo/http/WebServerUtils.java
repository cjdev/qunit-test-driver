...
public class WebServerUtils {
    ...
    public static JettyPlusPort launchHttpServer(final List<File> codePaths, final List<File> extraPathsToServe) {
        ...
        resources.add(new AutoGeneratedQunitHtmlWrappers());
