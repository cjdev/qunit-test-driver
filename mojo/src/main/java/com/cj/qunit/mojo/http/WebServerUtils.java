...
public class WebServerUtils {
    ...
    public static JettyPlusPort launchHttpServer(final List<File> codePaths, final List<File> extraPathsToServe, final String requireDotJsShim ) {
        ...
        resources.add(new AutoGeneratedQunitHtmlWrappers(requireDotJsShim));
